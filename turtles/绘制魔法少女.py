...
# @版本信息：0.0.1
# https://github.com/Seraphir/turtle-vectorgraph/blob/master/homura.py
from MagicFunctions import *
# import turtles
import time

# turtles.tracer 是为了加快作图，tracer(0) 就是将图形一次性画好;tracer(1)按照正常速度进行，可有可无
turtles.title("送给老九军们的虚拟女朋友：使用Python绘制魔法少女")
turtles.tracer(1)
turtles.setup(Width, Height, 0, 0)
turtles.pensize(1)
turtles.speed(5)
turtles.penup()
...
# 图层_3
turtles.color("black", "#2b1d2a")  # 外套内侧
Moveto(225, 462)
turtles.begin_fill()
Horizontal(165)
smooth_r(9, -15, 8, -25)
...
turtles.end_fill()
# 图层_4
turtles.color("black", "#2b1d29")  # 外套内侧
Moveto(225, 462)
turtles.begin_fill()
...
turtles.end_fill()
# 图层_8
turtles.color("black", "#E7F1FF")  # 白色褶皱
Moveto(225, 462)
turtles.begin_fill()
lineto(-3, -5)  # -3,-3,-3,-5
...
turtles.end_fill()
# 图层_10
turtles.color("black", "#A2B8D6")  # 衣领（透过领结）
Moveto(297, 387)
turtles.begin_fill()
lineto(-11, 6)
...
turtles.pensize(1)
# 图层_14
turtles.color("black", "#D1D1D1")  # 眼睛1
turtles.pensize(2)
Moveto(206, 212)
turtles.begin_fill()
lineto(15, -7)
...
turtles.end_fill()
# 图层_15
turtles.color("#0C1631", "#0C1631")  # 眼睛2
turtles.pensize(1)
Moveto(216, 206)
turtles.begin_fill()
...
# 图层_17
turtles.color("#F5F5F5", "#F5F5F5")  # 眼睛3
Moveto(253, 211)
turtles.begin_fill()
...
turtles.end_fill()
# 图层_18
turtles.color("#352F53", "#352F53")  # 眼睛4
Moveto(219, 229)
turtles.begin_fill()
smooth_r(2, -5, 6, -4)
smooth_r(18, 13, 27, 1)
...
# 图层_19
turtles.color("#9A90CB", "#9A90CB")  # 眼睛5
Moveto(227, 231)
turtles.begin_fill()
