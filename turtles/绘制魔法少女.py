...
# turtle.tracer 是为了加快作图，tracer(0) 就是将图形一次性画好;tracer(1)按照正常速度进行，可有可无
turtle.title("送给老九军们的虚拟女朋友：使用Python绘制魔法少女")
turtle.tracer(1)
...
# 图层_3
turtle.color("black", "#2b1d2a")  # 外套内侧
Moveto(225, 462)
turtle.begin_fill()
Horizontal(165)
smooth_r(9, -15, 8, -25)
...
turtle.end_fill()
# 图层_4
turtle.color("black", "#2b1d29")  # 外套内侧
Moveto(225, 462)
turtle.begin_fill()
...
turtle.end_fill()
# 图层_8
turtle.color("black", "#E7F1FF")  # 白色褶皱
Moveto(225, 462)
turtle.begin_fill()
lineto(-3, -5)  # -3,-3,-3,-5
...
turtle.end_fill()
# 图层_10
turtle.color("black", "#A2B8D6")  # 衣领（透过领结）
Moveto(297, 387)
turtle.begin_fill()
lineto(-11, 6)
...
turtle.end_fill()
# 图层_15
turtle.color("#0C1631", "#0C1631")  # 眼睛2
turtle.pensize(1)
Moveto(216, 206)
turtle.begin_fill()
...
# 图层_17
turtle.color("#F5F5F5", "#F5F5F5")  # 眼睛3
Moveto(253, 211)
turtle.begin_fill()
...
turtle.end_fill()
# 图层_18
turtle.color("#352F53", "#352F53")  # 眼睛4
Moveto(219, 229)
turtle.begin_fill()
smooth_r(2, -5, 6, -4)
smooth_r(18, 13, 27, 1)
...
# 图层_19
turtle.color("#9A90CB", "#9A90CB")  # 眼睛5
Moveto(227, 231)
turtle.begin_fill()
